...
```sh
  cd my-folder
  git clone https://github.com/mohametalmeari/i-budget.git
```
...
Feel free to check the [issues page](https://github.com/mohametalmeari/i-budget/issues).
